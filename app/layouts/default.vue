      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <div class="relative flex flex-1 flex-col overflow-hidden">
          ...
          <button
            ...
            class="absolute bottom-4 right-4 flex h-11 w-11 items-center justify-center border border-border-default bg-surface-overlay text-gray-400 shadow-lg transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-selected-border"
            aria-label="最上部へ戻る"
